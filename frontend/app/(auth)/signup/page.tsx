 ...
 * Illustration
 */
import signup_illustration from "@/assets/signup.svg";
        ...
        <div className="p-6">
          <CardHeader className="px-0">
            <CardTitle className="text-2xl font-bold">
              Create Your <span className="text-blue-500">MediFlow</span>{" "}
              Account
            </CardTitle>

            <CardDescription className="mt-1">
              Sign up to manage your healthcare journey with ease.
            </CardDescription>
          </CardHeader>
